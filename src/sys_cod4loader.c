...
//	SetCall(0x805b387, PushGroundEnt);
    ...
    *(byte*)0x80c0456 = 0x24;
    ...
    SetCall(0x080B59E0, Scr_LoadGameType);
    SetCall(0x080B59EA, Scr_StartupGameType);
    SetCall(0x080A85AD, Scr_PlayerConnect);
    SetCall(0x080A7FC1, Scr_PlayerDisconnect);
    SetJump(0x080B15F2, Scr_PlayerDamage);
    SetCall(0x080B1C75, Scr_PlayerKilled);
    SetCall(0x080ACC90, Scr_PlayerLastStand);
    SetCall(0x080B59E5, Scr_LoadLevel);
}
