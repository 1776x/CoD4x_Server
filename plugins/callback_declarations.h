...
#endif
#include "../src/plugin_eventparams.h"
#include "../src/sys_net.h"
...
//////////////////////////////////////////////
// Plugin script callback declarations
// Used to catch execution of script callback.
PCL void OnScript_GametypeLoaded();
PCL void OnScript_LevelLoaded();
PCL void OnScript_GametypeStarted();
PCL void OnScript_PlayerConnected(gentity_t* self);
PCL void OnScript_PlayerDisconnected(gentity_t* self);
PCL void OnScript_PlayerDamage(ScriptEventParams_OnPlayerDamage_t* params);
PCL void OnScript_PlayerKilled(ScriptEventParams_OnPlayerKilled_t* params);
PCL void OnScript_PlayerLastStand(ScriptEventParams_OnPlayerLastStand_t* params);
