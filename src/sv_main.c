...
void SV_InitCvarsOnce(void){
    ...
    sv_protocol = Cvar_RegisterInt("protocol", COD4X_PROTOCOL_VERSION, COD4X_PROTOCOL_VERSION, COD4X_PROTOCOL_VERSION, 0x44, "Protocol version");
...
void SV_BuildXAssetCSString()
{
    ...
    Com_sprintf(cs, sizeof(cs), "cod%d %s", COD4X_PROTOCOL_VERSION, list);
